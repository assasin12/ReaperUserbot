...
async def on_afk(event):
    ...
    if USER_AFK and not (await event.get_sender()).bot:  # pylint:disable=E0602
        ...
        message_to_reply = f"My Master Has Been Gone For {afk_since}\nWhere He Is: Tereko kyu batau " + \
            ...
            if reason \
            else f"**Important Notice**\n\n[This User Is Ded Forever. Donate some money to me to support my family and dont forget to type RIP SeD Reacts Onli...](https://telegra.ph//file/a53fa950ff31781d5930a.jpg) "
