...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("Connecting to official ReaperBot server and analysing that img ...")
        try:
            ...
            await event.edit("Sending to official ReaperBot team. Please have some Patience else fuck off!")
    ...
    if "image" in contentType:
        with io.BytesIO(output_file_name.content) as remove_bg_image:
            remove_bg_image.name = "ReaperBot.png"
        ...
        await event.edit("Removed dat annoying Backgroup in {} seconds, powered by reaperbot".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to ReaperBot Team\n`{}".format(output_file_name.content.decode("UTF-8")))
