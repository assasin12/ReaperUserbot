...
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id=953414679)\n\n"
                    "`Hello, this is ReaperBot Security Service.You have found your way here to my peruu master,`"
                    f"{DEFAULTUSER}`'s inbox.\n\n"
                    "Leave your name, phone number, address and 69k$ and hopefully you'll get a reply within 2 light years. NOTE - IF YOU SPAM MY INBOX I WILL SPAM YOUR MOMMY`S VAGINA WITH SPERMS. BE CAREFUL!`\n\n"
