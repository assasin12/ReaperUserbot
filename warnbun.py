...
async def _(event):
    if event.fwd_from:
        return
    mentions = "`You Have  1/3  warnings...\nWatch out!....\nReason for warn: YOU are a GAY or a RANDI!`"
...
async def _(event):
    if event.fwd_from:
        return
    mentions = "`You Have  2/3  warnings...\nWatch out!....\nReason for last warn: YOU are a GAY or a RANDI!`"
    chat = await event.get_input_chat()
    async for x in borg.iter_participants(chat, filter=ChannelParticipantsAdmins):
        mentions += f""
    reply_message = None
...
async def _(event):
    if event.fwd_from:
        return
    mentions = "`Warning Resetted By Admin...\nYou Have  0/3  warnings. Thanks the admin for removing warns else you gay`"
    chat = await event.get_input_chat()
    async for x in borg.iter_participants(chat, filter=ChannelParticipantsAdmins):
        mentions += f""
    reply_message = None
...
async def _(event):
    if event.fwd_from:
        return
    mentions = "**Warning..\n\nBattery Low, Dont charge your phone GTFO!**"
    chat = await event.get_input_chat()
    async for x in borg.iter_participants(chat, filter=ChannelParticipantsAdmins):
        mentions += f""
    reply_message = None
